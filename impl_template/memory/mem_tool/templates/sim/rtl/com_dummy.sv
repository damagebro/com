...
com_ecc_spram_shell    #( .DATA_W(128),.DEPTH(1024),.STRB_W(2),.MEM_USER(0) , .REQ_PIPE(0),.RSP_PIPE(0),.ECC_DW(64)     )     u_com_ecc_spram_shell_2();
...
com_ecc_tpram1ck_shell #( .DATA_W(128),.DEPTH(200),.STRB_W(4),.MEM_USER(10) , .REQ_PIPE(0),.RSP_PIPE(0),.ECC_DW(32)     )     u_com_ecc_tpram1ck_shell_2();
...
com_sprom_manual #( .DATA_W(30),.DEPTH(120),.MEM_USER(0) ) u_com_sprom_manual();
