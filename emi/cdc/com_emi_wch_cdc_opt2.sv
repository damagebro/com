...
`ifndef com_emi_wch_cdc_opt2_v
`define com_emi_wch_cdc_opt2_v
module com_emi_wch_cdc_opt2 #( parameter
    AW      = 32        ,
    DW      = 128       ,
    WCH     = 4         ,
    MAX_WCH = 16        ,
...
endmodule //end of com_emi_wch_cdc_opt2
`endif //end of com_emi_wch_cdc_opt2_v
