...
`ifndef com_emi_wrap_cdc_opt2_v
`define com_emi_wrap_cdc_opt2_v
module com_emi_wrap_cdc_opt2 #( parameter
...
endmodule //end of com_emi_wrap_cdc_opt2
`endif //end of com_emi_wrap_cdc_opt2_v
