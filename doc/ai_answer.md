...
当前阶段重点: RTL代码风格统一与 common RTL 文档编写。
...
### 2026-05-26 至今: common RTL 文档编写（进行中）

- 编写 `common_rtl_manual.md`，先覆盖 `com_arbiter_rr` 与 `com_find_lsb_first_one`。
- 默认只写功能、接口时序；按需补参数、接口、实现说明。
- 用 WaveDrom JSON 与本地 `wavedrom-cli` 生成 PNG，文档继续扩展。
