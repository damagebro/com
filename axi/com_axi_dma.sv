...
)u_com_axi_extd_wr_extd_wr[WCH-1:0] (
    .clk                  ( clk                        ),   //i
    .rst_n                ( rst_n                      ),   //i
    .clear                ( clear                      ),   //i
    .i_cfg_max_blen_m1    ( i_cfg_max_blen_m1          ),   //i
    .i_rx_ebus_wa_user    ( i_rx_ebus_wa_user          ),   //i
    .i_rx_ebus_wa_addr    ( i_rx_ebus_wa_addr          ),   //i
    .i_rx_ebus_wa_bytelen ( i_rx_ebus_wa_bytelen       ),   //i
    .i_rx_ebus_wa_valid   ( i_rx_ebus_wa_valid         ),   //i
    .o_rx_ebus_wa_ready   ( o_rx_ebus_wa_ready         ),   //o
    .i_rx_ebus_wd_data    ( i_rx_ebus_wd_data          ),   //i
    .i_rx_ebus_wd_valid   ( i_rx_ebus_wd_valid         ),   //i
    .o_rx_ebus_wd_ready   ( o_rx_ebus_wd_ready         ),   //o
    .o_rx_ebus_wb_valid   ( o_rx_ebus_wb_valid         ),   //o
    .o_tx_axi_awaddr      ( u_extd_wr_o_tx_axi_awaddr  ),   //o
    .o_tx_axi_awlen       ( u_extd_wr_o_tx_axi_awlen   ),   //o
    .o_tx_axi_awuser      ( u_extd_wr_o_tx_axi_awuser  ),   //o
    .o_tx_axi_awvalid     ( u_extd_wr_o_tx_axi_awvalid ),   //o
    .i_tx_axi_awready     ( u_extd_wr_i_tx_axi_awready ),   //i
    .o_tx_axi_wdata       ( u_extd_wr_o_tx_axi_wdata   ),   //o
    .o_tx_axi_wstrb       ( u_extd_wr_o_tx_axi_wstrb   ),   //o
    .o_tx_axi_wlast       ( u_extd_wr_o_tx_axi_wlast   ),   //o
    .o_tx_axi_wvalid      ( u_extd_wr_o_tx_axi_wvalid  ),   //o
    .i_tx_axi_wready      ( u_extd_wr_i_tx_axi_wready  ),   //i
    .i_tx_axi_bvalid      ( u_extd_wr_i_tx_axi_bvalid  ),   //i
    .o_tx_axi_bready      ( u_extd_wr_o_tx_axi_bready  )  //o
);
...
for( genvar gi=0; gi<RCH; gi++ )begin:gen_rch
    ...
    wire  [1:0]                 u_extd_rd_o_rdfifo_ram_we_n    ;
    ...
    com_axi_extd_rd #(
        ...
        .o_rdfifo_ram_we_n    ( u_extd_rd_o_rdfifo_ram_we_n    ),   //o
        ...
        .i_rx_ebus_ra_user    ( i_rx_ebus_ra_user         [gi] ),   //i
        .i_rx_ebus_ra_addr    ( i_rx_ebus_ra_addr         [gi] ),   //i
        .i_rx_ebus_ra_bytelen ( i_rx_ebus_ra_bytelen      [gi] ),   //i
        .i_rx_ebus_ra_valid   ( i_rx_ebus_ra_valid        [gi] ),   //i
        .o_rx_ebus_ra_ready   ( o_rx_ebus_ra_ready        [gi] ),   //o
        .o_rx_ebus_rd_data    ( o_rx_ebus_rd_data         [gi] ),   //o
        .o_rx_ebus_rd_last    ( o_rx_ebus_rd_last         [gi] ),   //o
        .o_rx_ebus_rd_valid   ( o_rx_ebus_rd_valid        [gi] ),   //o
        .i_rx_ebus_rd_ready   ( i_rx_ebus_rd_ready        [gi] ),   //i
        .o_tx_axi_araddr      ( u_extd_rd_o_tx_axi_araddr [gi] ),   //o
        .o_tx_axi_arlen       ( u_extd_rd_o_tx_axi_arlen  [gi] ),   //o
        .o_tx_axi_aruser      ( u_extd_rd_o_tx_axi_aruser [gi] ),   //o
        .o_tx_axi_arvalid     ( u_extd_rd_o_tx_axi_arvalid[gi] ),   //o
        .i_tx_axi_arready     ( u_extd_rd_i_tx_axi_arready[gi] ),   //i
        .i_tx_axi_rdata       ( u_extd_rd_i_tx_axi_rdata  [gi] ),   //i
        .i_tx_axi_rlast       ( u_extd_rd_i_tx_axi_rlast  [gi] ),   //i
        .i_tx_axi_rvalid      ( u_extd_rd_i_tx_axi_rvalid [gi] ),   //i
        .o_tx_axi_rready      ( u_extd_rd_o_tx_axi_rready [gi] )  //o
    );
    if( RAM_ONE_DEPTH>0 )begin:gen_rch_sram
    com_spram_shell #(
        .DATA_W ( RAM_DW        ),   //32
        .DEPTH  ( RAM_ONE_DEPTH )  //, //512
    )u_com_spram_shell_rdfifo_ram[1:0]
    (
        .clk            ( clk                            ),   //i
        .i_cfg_mem_ctrl ( i_cfg_mem_ctrl                 ),   //i
        .i_ce_n         ( u_extd_rd_o_rdfifo_ram_ce_n    ),   //i
        .i_we_n         ( u_extd_rd_o_rdfifo_ram_we_n    ),   //i
        .i_addr         ( u_extd_rd_o_rdfifo_ram_addr    ),   //i
        .i_wr_data      ( u_extd_rd_o_rdfifo_ram_wr_data ),   //i
        .o_rd_data      ( u_extd_rd_i_rdfifo_ram_rd_data )  //o
    );
    end:gen_rch_sram
    else begin
