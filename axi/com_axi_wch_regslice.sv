...
if( WA_BEFORE_WD_EN>0 )begin
    ...
    (
        ...
        .rst_n                ( rst_n                     ), //i
        .clear                ( clear                     ), //i
        .wr_en                ( u_wa_before_wd_i_wr_en    ), //i
        .wr_data              ( u_wa_before_wd_i_wr_data  ), //i
        .wr_full              ( u_wa_before_wd_o_wr_full  ), //o
        .rd_en                ( u_wa_before_wd_i_rd_en    ), //i
        .rd_data              ( u_wa_before_wd_o_rd_data  ), //o
        .rd_empty             ( u_wa_before_wd_o_rd_empty ), //o
        .water_level          (                           )  //o
    );
end
else begin
